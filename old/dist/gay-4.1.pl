...
%IRSSI = (
	...
	changed		=> 'Thu Aug 14 15:21:02 PDT 2003',
	version		=> $VERSION,
);
...
/spook               interject spook stuff

SETTINGS:

/set cowfile <cowsay file>
/set figfont <figlet file>
/set linewrap <# to wrap at>
...
/set matrix_size, #
/set matrix_spacing #
/set spook_words # (# of words for spook to use)
EOH
...
Irssi::command_bind("spook", \&spook);
